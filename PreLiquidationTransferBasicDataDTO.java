...
public class PreLiquidationTransferBasicDataDTO {
    ...
    public PreLiquidationTransferBasicDataDTO(Date fechaEmisionTransf, Double impTransferencia, Double impComision, Double impGastos, Double impLiquido, String nombreOrdenante, String descCuentaAbono, String descCuentaCargo, String impTotalDivBase) {
    ...
    public PreLiquidationTransferBasicDataDTO() {
    }
